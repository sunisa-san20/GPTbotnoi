...
const BotnaiGPTIcon = () => (
     ...
     <div className="w-28 h-28 bg-cyan-500 rounded-full flex items-center justify-center overflow-hidden">
              <img src="/images/botlogo.jpg" alt="Bot Logo" className="w-full h-full object-cover" />
              </div>
...
export default function ChatPage() {
    ...
    <div className="flex-1 bg-white flex flex-col">
      ...
      <div className="p-4 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="w-10 h-10 bg-cyan-500 rounded-full flex items-center justify-center overflow-hidden">
        <img src="/images/botnoilogo.jpg" alt="Bot Logo" className="w-full h-full object-cover" />
          </div>
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
     <div className="w-[64px] h-screen bg-gradient-to-b from-cyan-400 to-blue-500 flex flex-col items-center justify-between py-4">
  {/* 🔹 TOP SECTION: Logo หรือเมนูหลัก */}
  ...
  {/* 🔻 BOTTOM SECTION: Profile และ Logout */}
  <div className="flex flex-col items-center space-y-3 mb-10 " >
    ...
    >
      ...
      {/* Chat List Panel */}
      {isChatPanelOpen && (
        <div className="w-[300px] bg-white border-r border-gray-200 flex flex-col transition-all duration-300 ease-in-out">
